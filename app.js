...
const CONFIG = {
  ...
  GAS_URL: 'https://script.google.com/macros/s/AKfycbyZN2aHtn1PH2LrgSwxrt0o-ldfZVprepfMnJtdXpxO7LF86VvIjHZOLFny-618zP2Y/exec',
...
async function confirmHapus() {
  ...
  try {
    ...
    // FORCED SYNC: Menarik ulang semua data dari Google Sheets untuk menghindari stale-index
    toast('Data berhasil dihapus dari Sheets, sedang sinkronisasi...', 'info');
    await syncData();
