...
async function simpanKas() {
  ...
  const record = { id:genId(), nama, tanggal, kelas, jurusan, nextReminder: hitungReminder(tanggal), status, nominal, keterangan:ket, owner:state.currentUser, createdAt:new Date().toISOString() };
