...
async function bukaKamera(){
    ...
    try{
        ...
        if(
            ...
            toast(
                "Izin kamera ditolak atau ada aplikasi overlay aktif",
                "warning"
            );
...
function isiFormOtomatis(text){
  ...
  const nama=
  text.match(
  /nama\s*:?\s*(.*?)\s+(kelas|jurusan|nominal|$)/i
  );
