...
async function ambilFotoVerif() {
  ...
  await prosesVerifikasiGambar(file);
}
...
async function prosesVerifikasiGambar(file) {
  ...
  try {
    ...
    console.log(`[VERIF KAS] Similarity Score: ${similarity}%`);
    
    // Threshold minimal 65% sesuai instruksi
    const isSuccess = similarity >= 25;
